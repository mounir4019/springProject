...
private CustomUserDetailsService customUserDetailsService;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		/* cors(corsCustomizer -> {
		   ...
		   .requestMatchers(HttpMethod.GET,"/administration/allLivreurs").hasRole("ADMIN") 
		   .requestMatchers(HttpMethod.GET,"/administration/allEntrepriseLivraison").hasRole("ADMIN") 
		   .requestMatchers(HttpMethod.POST,"/administration/livraisons").hasRole("ADMIN") 
		   .requestMatchers(HttpMethod.POST,"/administration/livraisonProduit").hasRole("ADMIN") 
		   .requestMatchers(HttpMethod.POST,"/administration/AllLivraisonByCmd").hasRole("ADMIN") 
